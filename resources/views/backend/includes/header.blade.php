    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        <div class="navbar-header" data-logobg="skin6">
            ...
            <a class="navbar-brand" href="dashboard.html">
                ...
                <b class="logo-icon">
                    <!-- Dark Logo icon -->
                    <img src="{{URL::asset('backend/plugins/images/logo_dark.png')}}" alt="homepage" />
                </b>
                <!--End Logo icon -->
                <!-- Logo text -->
            </a>
            ...
            <ul class="navbar-nav ml-auto d-flex align-items-center">
                ...
                <li>
                    <a class="profile-pic" href="#">
                        <img src="{{URL::asset('backend/plugins/images/users/varun.jpg')}}" alt="user-img" width="36" class="img-circle"><span
